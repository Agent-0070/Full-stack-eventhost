...
import { Bell, Check, Filter, Search, ArrowLeft, Eye, Download, User, Calendar, DollarSign, CreditCard, FileText } from 'lucide-react';
import { useBookingNotifications, getNotificationIcon, getNotificationColor, BookingNotification } from '../hooks/useBookingNotifications';
                        ...
                        {selectedNotification.data.receiptId && (
                          <div className="p-4 bg-gray-50 dark:bg-gray-950/20 rounded-lg border border-gray-200 dark:border-gray-800">
                            ...
                            <div className="space-y-3">
                              ...
                              <Button
                                onClick={() => {
                                  // Open receipt image in new tab
                                  window.open(`/api/payment-receipts/${selectedNotification.data.receiptId}/image`, '_blank');
                                }}
          ...
          {Object.keys(groupedNotifications).length === 0 ? (
            ...
            <div className="space-y-6">
              {Object.entries(groupedNotifications)
                ...
                .map(([date, dayNotifications]: [string, BookingNotification[]]) => (
                <div key={date}>
