...
import { Camera, Save, X, Upload, Plus, Trash2, Building, Users, Globe, Award } from 'lucide-react';
...
const ProfileEdit: React.FC = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    displayPicturePublicId: currentUser?.displayPicturePublicId || '',
  ...
  const updatePastEvent = (index: number, field: string, value: any) => {
    setFormData(prev => ({
      ...prev,
      pastEvents: prev.pastEvents.map((event, i) =>
  ...
  const removeHostingCountry = (index: number) => {
    setFormData(prev => ({
      ...prev,
      hostingCountries: prev.hostingCountries.filter((_, i) => i !== index)
    }));
  };
  ...
  const updateHostingCountry = (index: number, value: string) => {
    setFormData(prev => ({
      ...prev,
      hostingCountries: prev.hostingCountries.map((country, i) =>
    ...
    if (file) {
      ...
      try {
        ...
        if (response.ok) {
          ...
          setFormData(prev => ({ ...prev, displayPicture: uploadResult.url, displayPicturePublicId: uploadResult.publicId }));
          toast({
  ...
  const handleRemovePhoto = async () => {
    try {
      if (formData.displayPicturePublicId) {
        const token = localStorage.getItem('auth-token');
        await fetch(`/api/upload/image/${encodeURIComponent(formData.displayPicturePublicId)}`, {
          method: 'DELETE',
            ...
            <CardContent className="space-y-6">
              ...
              <div className="text-center">
                <Label htmlFor="image-upload" className="cursor-pointer">
                  <div className="inline-flex items-center justify-center px-4 py-2 border border-glass-border/30 rounded-md bg-glass-light/10 hover:bg-glass-light/20 transition-colors">
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  className="bg-glass-light/10 border-glass-border/30 min-h-[80px]"
                />
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  className="bg-glass-light/10 border-glass-border/30 min-h-[100px]"
                />
                <p className="text-xs text-muted-foreground">
              ...
              <div className="space-y-4">
                ...
                {formData.hostingCountries.map((country, index) => (
                  <div key={index} className="flex gap-2">
                    <Select value={country} onValueChange={(value) => updateHostingCountry(index, value)}>
                      <SelectTrigger className="bg-glass-light/10 border-glass-border/30">
              ...
              <div className="space-y-4">
                ...
                {formData.pastEvents.map((event, index) => (
                  <div key={index} className="p-4 border border-glass-border/30 rounded-lg space-y-3">
                  ...
                  <div key={index} className="p-4 border border-glass-border/30 rounded-lg space-y-3">
                    ...
                    <div>
                      ...
                      <Textarea
                        ...
                        className="bg-glass-light/10 border-glass-border/30 min-h-[60px]"
                      />
                    </div>
                  </div>
                ))}
