    ...
    try {
      ...
      if (success) {
        toast({
          ...
          description: 'Welcome to IM-Host! You can now access all features.',
        });
          ...
          <Card className="backdrop-blur-glass bg-gradient-glass border-glass-border/30 shadow-glass">
            ...
            <CardContent>
              <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                <TabsList className="grid w-full grid-cols-2 mb-6 backdrop-blur-glass bg-gradient-glass border border-glass-border/30">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        ...
                        <Input
                          ...
                          className="pl-10 bg-glass-light/10 border-glass-border/30"
                          required
                        />
                      </div>
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        ...
                        <Input
                          ...
                          className="pl-10 pr-10 bg-glass-light/10 border-glass-border/30"
                          required
                        />
                        <button
                          type="button"
                ...
                <TabsContent value="register">
                  <form onSubmit={handleRegister} className="space-y-4">
                    ...
                    <Button 
                      type="submit" 
                      className="w-full bg-gradient-accent border-0 shadow-accent-glow"
                      disabled={isLoading}
                    >
