  ...
  const handleEventCreate = (eventData: any) => {
    try {
      ...
      toast({
        ...
        description: 'Your event has been created and is now visible to everyone.',
      });
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        >
          <h1 className="text-4xl md:text-5xl font-bold mb-4">
            Create <span className="bg-gradient-primary bg-clip-text text-transparent">Event</span>
          </h1>
