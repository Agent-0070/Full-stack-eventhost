...
const EventCreationWizard: React.FC<EventCreationWizardProps> = ({
  ...
  const renderPaymentMethodForm = () => {
    return (
      <div className="space-y-4 p-4 border border-glass-border/30 rounded-lg bg-glass-light/5 backdrop-blur-sm">
        <div>
  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <Card>
        ...
        {/* Navigation */}
        <div className="flex justify-between p-6 border-t border-glass-border/30">
