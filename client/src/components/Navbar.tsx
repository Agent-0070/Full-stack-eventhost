  ...
  return (
    <div className="relative">
      <Button
        ...
        className="relative w-10 h-10 p-0 rounded-full backdrop-blur-sm bg-glass-light/20 border border-glass-border/30 hover:bg-glass-light/30"
      >
        ...
        {unreadCount > 0 && (
          <motion.span
            initial={{ scale: 0 }}
            animate={{ scale: 1 }}
            className="absolute -top-1 -right-1 bg-destructive text-destructive-foreground text-xs rounded-full w-5 h-5 flex items-center justify-center font-bold shadow-lg animate-pulse"
          >
      ...
      {isOpen && (
        <motion.div
          ...
          className="absolute top-12 right-0 w-80 bg-card/95 backdrop-blur-md border border-border rounded-lg shadow-lg z-50"
        >
...
const Navbar: React.FC = () => {
  ...
  return (
    <motion.nav
      initial={{ y: -100 }}
      animate={{ y: 0 }}
      className="fixed top-0 left-0 right-0 z-50 backdrop-blur-glass bg-gradient-glass border-b border-glass-border/20 shadow-glass"
    >
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <Link to="/" className="flex items-center space-x-3">
            ...
            >
              ...
              <motion.div
                className="absolute inset-0 rounded-lg opacity-0 bg-gradient-primary blur-md"
