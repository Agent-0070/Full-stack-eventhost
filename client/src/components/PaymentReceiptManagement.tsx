...
const PaymentReceiptManagement: React.FC = () => {
                      ...
                      <Dialog>
                        <DialogTrigger asChild>
                          <Button
                            ...
                            className="bg-glass-light/10 border-glass-border/30 hover:bg-glass-light/20 backdrop-blur-sm"
                          >
                            ...
                            <div className="space-y-4">
                              ...
                              <div className="flex justify-end space-x-2">
                                <Button
                                  ...
                                  className="bg-glass-light/10 border-glass-border/30 hover:bg-glass-light/20 backdrop-blur-sm text-red-600 hover:text-red-700 border-red-200/50"
                                >
                                ...
                                <Button
                                  ...
                                  disabled={actionLoading}
                                  className="bg-glass-light/10 border-glass-border/30 hover:bg-glass-light/20 backdrop-blur-sm text-green-600 hover:text-green-700 border-green-200/50"
                                >
