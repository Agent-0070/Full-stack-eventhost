...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-gradient-glass backdrop-blur-glass border-t border-glass-border/20 mt-auto">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              <div className="relative">
                <div className="w-8 h-8 bg-gradient-primary rounded-lg flex items-center justify-center font-bold text-white text-lg">
                  iM
                </div>
            ...
            <div className="flex space-x-4">
              <a
                ...
                className="w-10 h-10 rounded-full backdrop-blur-sm bg-glass-light/20 border border-glass-border/30 hover:bg-glass-light/30 transition-colors flex items-center justify-center group"
                aria-label="GitHub"
              >
        ...
        <div className="mt-8 pt-6 border-t border-glass-border/20">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="flex items-center space-x-2 text-sm text-muted-foreground">
              <span>© {currentYear} iM Event Platform. All rights reserved.</span>
            </div>
            <div className="flex items-center space-x-2 text-sm text-muted-foreground">
