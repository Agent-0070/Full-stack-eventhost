...
export const NotificationSystem: React.FC<NotificationCenterProps> = ({ className }) => {
  ...
  return (
    <>
      ...
      {isOpen && (
        <div className="fixed top-16 right-4 w-80 bg-glass-light backdrop-blur-md border-glass-border rounded-lg shadow-glass-lg z-dropdown animate-slide-in-right">
            ...
            if ('Notification' in window) {
              Notification.requestPermission().then(permission => {
                if (permission === 'granted') {
                  new Notification('Im-Host Notifications', {
...
export const EmailNotificationSettings: React.FC = () => {
  ...
  return (
    <div className="space-y-4 p-6 bg-glass-light backdrop-blur-md border-glass-border rounded-lg">
