...
import { Calendar, Clock, MapPin, MessageSquare, Trash2, AlertTriangle, Users, Bell, Edit, CalendarX } from 'lucide-react';
...
const EventManagementActions: React.FC<EventManagementActionsProps> = ({ event, onEdit }) => {
  const { updateEventStatus, deleteEvent, sendEventNotification } = useEvents();
  ...
  return (
    <div className="flex gap-2 flex-wrap">
      ...
      <Button
        ...
        className="bg-glass-light/10 border-glass-border/30 hover:bg-glass-light/20"
      >
